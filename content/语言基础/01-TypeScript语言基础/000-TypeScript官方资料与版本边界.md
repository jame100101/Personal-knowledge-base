...
2026-09-20 重新核对官方公告：TypeScript 7.0 已于 2026-07-08 发布，核心编译器和语言服务从 JavaScript/TypeScript 代码库迁移到 Go 原生实现，主要目标是显著改善检查和编辑器性能。它尽量保持 TypeScript 6.0 的类型检查与命令行行为兼容，但仍有三个工程边界：
